...
IMG ?= us-west1-docker.pkg.dev/stickbreak-489423/stickbreak1/controller:dev
...
PRE_IMG ?= us-west1-docker.pkg.dev/stickbreak-489423/stickbreak1/operator:dev #$(shell git describe --always --dirty)
...
deploy: manifests kustomize ## Deploy controller to the K8s cluster specified in ~/.kube/config.
	kubectl config set-context --current --namespace=cosmos-operator-system
